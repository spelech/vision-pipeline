...
from secrets_manager import upsert_secret
from services.registry import gmail_ingestor, receipt_wrangler_client
from tasks import ingest_receipt_jobs_direct
...
async def gmail_ingest_direct(
    ...
    ingestion_result = await ingest_receipt_jobs_direct(
        db,
        background_tasks,
        receipts_payload,
        data.pipeline_id,
